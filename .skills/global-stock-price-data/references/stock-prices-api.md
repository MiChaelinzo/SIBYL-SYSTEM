Stock Prices API
Endpoint: GET https://app-c7vje3odisxt-api-oYA6Z8wDBN1a.gateway.appmedo.com/v1/data/quote
...
async function getStockPrices(
  ...
  const response = await fetch(
    `https://app-c7vje3odisxt-api-oYA6Z8wDBN1a.gateway.appmedo.com/v1/data/quote?${query.toString()}`,
