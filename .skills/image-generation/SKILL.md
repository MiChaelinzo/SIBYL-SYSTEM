name: image-generation description: Generate images from text prompts or input images using an async API. Use this skill whenever the user wants to create, generate, or edit images — including text-to-image, image-to-image style transfer, or compositing multiple images. The workflow is submit a task, then poll until complete, then save the result. Triggers on requests like "generate an image of...", "create a picture of...", "convert this photo to...", "make an illustration of...", or any request involving AI image creation or editing. license: MIT
