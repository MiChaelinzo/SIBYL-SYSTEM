name: kling-image-generation description: Generate images from text or a reference image via Kling AI. Use for text-to-image and visual asset creation. license: MIT
...
Overview
Item	Details
Create Task Endpoint	POST https://app-c7vje3odisxt-api-DY8MnRlwkXKa.gateway.appmedo.com/v1/images/generations
Query Task Endpoint	GET https://app-c7vje3odisxt-api-M9v0wzOkZXGY.gateway.appmedo.com/v1/images/generations/{task_id}
...
async function createImageTask(params: {
  ...
  const response = await fetch(
    "https://app-c7vje3odisxt-api-DY8MnRlwkXKa.gateway.appmedo.com/v1/images/generations",
    {
      method: "POST",
      headers: {
...
async function queryImageTask(taskId: string): Promise<{
  ...
  const response = await fetch(
    `https://app-c7vje3odisxt-api-M9v0wzOkZXGY.gateway.appmedo.com/v1/images/generations/${taskId}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
