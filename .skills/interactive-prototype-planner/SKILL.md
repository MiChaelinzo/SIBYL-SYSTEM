name: interactive-prototype-planner description: Plans interactive HTML or React prototypes with component structure, states, flows, and user interactions. Use when user wants to create interactive prototypes, web artifacts, or design component trees and state flows before coding. license: MIT
