name: documentation-and-adrs description: 记录架构决策和文档。当做出重大技术决策、选择技术方案、变更公共 API、发布功能或需要记录代码库上下文时使用。提供 ADR（架构决策记录）模板、文档协作工作流、代码注释规范和 README 结构指南。当用户需要写文档、创建提案、起草技术规范或记录决策时触发。 license: MIT
