name: spec-driven-documentation description: Unified workflow combining document co-authoring and spec-driven development. Use when creating documents, proposals, RFCs, technical specs, or when user says "write a doc", "draft", "create a spec", "specification". license: MIT
