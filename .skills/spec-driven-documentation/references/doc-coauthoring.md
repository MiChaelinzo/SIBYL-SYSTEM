...
Context Gathering: You provide all relevant context while I ask clarifying questions
Refinement & Structure: We agree on structure and iterate on content
Reader Testing: Test the document with representative readers
What to Collect
...
Purpose — What should readers know or do after?
Scope — What's in/out of bounds?
Key decisions — Any constraints or requirements?
...
Announce section being drafted
Present draft based on user context and selections
Ask for feedback
