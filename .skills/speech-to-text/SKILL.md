name: speech-to-text description: Transcribe audio files or URLs to text using Whisper v3, supporting 100+ languages, speaker diarization, and multiple output formats (JSON/SRT/VTT/verbose_json). Use this skill whenever the user wants to convert speech or audio to text, generate subtitles, transcribe podcasts, recognize speakers, or process audio files into readable transcripts. license: MIT
