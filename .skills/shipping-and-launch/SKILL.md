name: shipping-and-launch description: Prepares production launches. Use when preparing to deploy to production, need a pre-launch checklist, setting up monitoring, planning a staged rollout, or need a rollback strategy. license: MIT
Shipping and Launch
