name: google-text-translation description: Translate text between languages using Google Cloud Translation API. Use this skill whenever the user wants to translate text, detect a source language, or convert content between languages — including bulk translation, multilingual form handling, or any i18n/localization task in an app. license: MIT
...
Item	Details
Endpoint	POST https://app-c7vje3odisxt-api-GaDwZ8DX7jPY.gateway.appmedo.com/language/translate/v2
...
async function translateText(params: TranslateParams): Promise<TranslationResult[]> {
  const response = await fetch(
    "https://app-c7vje3odisxt-api-GaDwZ8DX7jPY.gateway.appmedo.com/language/translate/v2",
    {
      method: "POST",
      headers: {
