name: writing-guidelines-reviewer description: Reviews docs, tutorials, website copy, help center articles, and pricing pages for clarity, structure, tone, and usability. Use when asked to "review my docs", "check writing style", "audit prose", or "improve clarity". license: MIT
