name: the-news description: Access global news from thousands of sources via The News API. Use this skill whenever the user wants to fetch top stories, search all news articles, find similar articles, retrieve a specific article by UUID, or discover available news sources. Trigger on any request involving current events, news search, news filtering, or news data retrieval. license: MIT
The News
...
Capability Overview
Endpoint	Method	URL
Top Stories	GET	https://app-c7vje3odisxt-api-wL1zlEdVM6DY.gateway.appmedo.com/v1/news/top
All News	GET	https://app-c7vje3odisxt-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all
Similar News	GET	https://app-c7vje3odisxt-api-m9xKXDbR1oka.gateway.appmedo.com/v1/news/similar/{uuid}
News by UUID	GET	https://app-c7vje3odisxt-api-qYGWo8XA7M7Y.gateway.appmedo.com/v1/news/uuid/{uuid}
Sources	GET	https://app-c7vje3odisxt-api-oLpZ7eD5jJ5a.gateway.appmedo.com/v1/news/sources
Base host: app-c7vje3odisxt-api-wL1zlEdVM6DY.gateway.appmedo.com
