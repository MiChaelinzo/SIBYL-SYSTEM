name: pricing-page-design description: 帮助 SaaS 或应用设计价格梯度、套餐对比、文案和转化策略。借鉴 Marketing Skills 的 pricing / conversion 思路和 Vercel writing guidelines 对 pricing pages 的强调。不提供财务投资建议，只帮助组织定价页表达、套餐结构和 FAQ。当用户需要设计定价页、优化套餐结构、撰写定价文案或处理定价异议时触发。 license: MIT
