name: google-scholar description: Search Google Scholar for academic papers, citations, and literature via SerpApi. Use this skill whenever the user needs to find academic papers, research literature, citation counts, related versions of a paper, or wants to search Google Scholar by keyword, author, year range, or article ID. license: MIT
...
Property	Value
Endpoint	GET https://app-c7vje3odisxt-api-Xa6JZq2055oa.gateway.appmedo.com/search
...
Response Example
{
  ...
  "pagination": {
    "current": 1,
    "next": "https://app-c7vje3odisxt-api-Xa6JZq2055oa.gateway.appmedo.com/search?start=10"
  }
}
...
async function searchGoogleScholar(params: ScholarSearchParams): Promise<ScholarResponse> {
  ...
  const response = await fetch(
    `https://app-c7vje3odisxt-api-Xa6JZq2055oa.gateway.appmedo.com/search?${queryParams.toString()}`,
    {
      method: "GET",
      headers: {
